...
<li> <a href="<?php echo base_url()?>main/singleview">My Booking</a>
  <li> <a href="<?php echo base_url()?>main/ticket">My Ticket</a>
     <li> <a href="<?php echo base_url()?>main/usernotification">Notifications</a>
